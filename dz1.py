...
if "Нет" == enter:
    ...
    if enter == "2":
        ...
        enter = input ("Назвать число:")

        if enter == "4":
            print ("Поздравляю, ты угадал, можешь проходить!")
        else:
            print ("Прости, путник, ты не угадал")



            print("Вы осматриваете комнаты и находите дверь, на которой стоит панель с двузначным паролем")
            while True:
                inp = input ("Введите пароль")
                try:
                    inp = int(inp)
                    print (f"{inp} не подходит")
                finally:
